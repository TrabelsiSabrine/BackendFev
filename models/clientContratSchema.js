...
const clientContratSchema = new mongoose.Schema({
  client: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },  // Référence au client
  produit: { type: mongoose.Schema.Types.ObjectId, ref: 'Produit' },  // Référence au produit/contrat
